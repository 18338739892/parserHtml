...
%>
<script type="text/javascript" src="<%=contextPath%>/lib/jquery-easyui-1.4/jquery.easyui.min.js" charset="utf-8"></script>
<script type="text/javascript" charset="utf-8">
  ...
  var downloadfile = function() {
    var url = "<%=contextPath%>/downloadFile.action?path=" + encodeURI("/video/jmfczzn.mp4") + 
        "&filename=" + encodeURI("金蜜蜂聚合缴费平台操作指南.mp4");
...
<%--   <img src="<%=contextPath%>/lib/style/images/login/logo2.png" > --%>
	<h1 style="color:white;font-size:20px;">金蜜蜂聚合缴费管理平台</h1>
</div>
<!-- 显示欢迎信息 -->
...
<!-- 	<a href="javascript:void(0);" class="easyui-menubutton" data-options="menu:'#layout_north_pfMenu',iconCls:'ext-icon-rainbow'">
	...
	<a href="javascript:void(0);" class="easyui-menubutton" data-options="menu:'#layout_north_kzmbMenu',iconCls:'ext-icon-cog'">
	...
	<form method="post" class="form" onsubmit="return false;">
		<table class="table">
			<tr>
				...
				<td>
					<input name="adminInfoVO.useraccno" readonly="readonly" value='<s:property value="#session.sysUserInfo.useraccno"/>'/>
				</td>
			</tr>
			<tr>
				<th>密码</th>
...
<link href="<%=contextPath%>/lib/video/video-js.min.css" rel="stylesheet">
<script src="<%=contextPath%>/lib/video/video.min.js"></script>
<!-- 操作指南 -->
